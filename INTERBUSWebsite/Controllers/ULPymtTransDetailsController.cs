...
{
    public class ULPymtTransDetailsController : ApiController
    {
          [HttpGet]

        public DataTable ULPymtTransT()
        {
            ...
            cmd.CommandText = "GetULPymtTransDetails";
            cmd.Connection = conn;
        ...
        [HttpPost]
        public HttpResponseMessage SaveType(ULPymtTransDetails b)
        {
