...
namespace INTERBUSWebsite.Controllers
{
    public class PaymentsController : ApiController
    {
        ...
        public static string GetPaymentAck(decimal amt, string cardno, string cvv, string expirydate)
        {
            string btposTransId = "-1";
            ...
            try
            {
               #region paypal
                ...
                // a request id if you do not pass one explicitly. 
                // See [Configuration.cs](/Source/Configuration.html) to know more about APIContext.
                var apiContext = Controllers.Configuration.GetAPIContext();
                    ...
                    funding_instruments = new List<FundingInstrument>()
                {
                    new FundingInstrument()
                    {
                        credit_card = new CreditCard()
                        {
                            ...
                            first_name = "admin",
                            last_name = "admin",
                            number = "4032034430197676",//"4024007185826731",//"4877274905927862",
                            type = "visa"
                        }
                    }
                },
                ...
                btposTransId = createdPayment.id;
