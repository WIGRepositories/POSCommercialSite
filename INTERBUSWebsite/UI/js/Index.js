	function fun(){
		if(document.getElementById("mySelect").value==2){//if Booking Type
		    $("#searchButton").attr("href", "booking.html");
		}else if(document.getElementById("mySelect").value==3){//if Hiring Type
		    $("#searchButton").attr("href", "vehicleAvailability.html");
